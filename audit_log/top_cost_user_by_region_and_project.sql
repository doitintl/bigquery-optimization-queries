...
WITH src AS (
    SELECT
        ...
        ROUND(SAFE_DIVIDE(protopayload_auditlog.servicedata_v1_bigquery.jobCompletedEvent.job.jobStatistics.totalBilledBytes, POW(1024, 3)) * 6.25, 2) AS onDemandCost,
