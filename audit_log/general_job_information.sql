...
WITH src AS (
    SELECT
        ...
        ROUND(SAFE_DIVIDE(COALESCE(protopayload_auditlog.servicedata_v1_bigquery.jobCompletedEvent.job.jobStatistics.totalBilledBytes, 0), 102400000000) * 5, 2) AS cost,
