...
Note that these queries go along with the DoiT Engineering Blog series located [here](https://engineering.doit.com/bigquery-optimizations-part-1-6d188689af1c).
