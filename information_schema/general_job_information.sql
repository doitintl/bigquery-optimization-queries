...
BEGIN
    WITH src AS (
      SELECT
        ...
        ROUND(COALESCE(total_bytes_billed, 0) / 1000000, 2) AS totalMegabytesBilled,
        ROUND(COALESCE(total_bytes_billed, 0) / 1000000000, 2) AS totalGigabytesBilled,
        ROUND(COALESCE(total_bytes_billed, 0) / 1000000000000, 2) AS totalTerabytesBilled,
